...
import com.dubbo.mock.test.handler.StreamHandler;
...
public class ProcessClient extends Thread {
    ...
    private void putFlag() {
        ...
        redisResolver.set(Const.DUBBO_MOCK_DOWNLOAD_JAR_TASK, Const.RUNNING_FlAG, 1, TimeUnit.HOURS);
    }
    ...
    private void removeFlag() {
        ...
        redisResolver.del(Const.DUBBO_MOCK_DOWNLOAD_JAR_TASK);
    }
    /**
     * get the cmd code.
     *
    ...
    public boolean isRunning() {
        ...
        if (redisResolver.hasKey(Const.DUBBO_MOCK_DOWNLOAD_JAR_TASK)) {
            log.info("some task was already running at background, please try again for a few minutes later.");
            return true;
        }
        return false;
    }
