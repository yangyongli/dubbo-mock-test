...
import com.dubbo.mock.test.auth.MenuNode;
import com.dubbo.mock.test.auth.MenuTree;
import com.dubbo.mock.test.service.MenuService;
import com.dubbo.mock.test.util.JsonFileUtil;
...
public class MenuServiceImpl implements MenuService {
    ...
    private String getProjectRealPath() throws FileNotFoundException {
        ...
        // useless when you run  in the jar way, so comment these code.
